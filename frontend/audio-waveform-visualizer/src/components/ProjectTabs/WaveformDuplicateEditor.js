...
const WaveformDuplicateEditor = ({ 
  ...
  return (
    <>
      {/* Step 2: Align to Silence (Moved to Top) */}
      <div className="align-silence-step-card" style={{
        ...
        <div className="align-silence-controls" style={{ 
          ...
          <div className="control-group" style={{ display: 'flex', flexDirection: 'column', flex: '1', minWidth: '200px' }}>
            <label style={{ fontSize: '0.875rem', fontWeight: '600', color: '#334155', marginBottom: '0.5rem' }}>
          ...
          <button 
            ...
            disabled={isAligningToSilence || createdRegionsRef.current.size === 0}
            style={{
              ...
              borderRadius: '6px',
              fontWeight: 'bold',
              cursor: (isAligningToSilence || createdRegionsRef.current.size === 0) ? 'not-allowed' : 'pointer',
              opacity: (isAligningToSilence || createdRegionsRef.current.size === 0) ? 0.7 : 1,
              display: 'flex',
              alignItems: 'center',
              gap: '0.5rem',
              whiteSpace: 'nowrap',
            ...
            onMouseOver={(e) => {
              if (!isAligningToSilence && createdRegionsRef.current.size > 0) {
